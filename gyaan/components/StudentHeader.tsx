...
const menuItems = [
  { name: "Home", href: "/profile/student" },
  { name: "Courses", href: "/explore" },
  { name: "Resources", href: "/profile/resources" },
  { name: "Forums", href: "/profile/forums" },
  { name: "Announcements", href: "/profile/announcements" },
  { name: "My Learning", href: "/profile/my-learning" },
];
...
export default function StudentHeader() {
  ...
  return (
    <div className="relative w-full bg-customColor-1 border border-b border-black text-1xl p-1 z-20" id="hero-one">
